			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Sign In now, Let's start your Cool Music Shopping. Don't have an account?
							<a href="#" data-toggle="modal" data-target="#myModal2">
								Sign Up Now</a>
						</p>
						<form action="#" method="post">
			...
			<div class="agileits-navi_search">
				<form action="#" method="post">
					<select id="agileinfo-nav_search" name="agileinfo_search" required="">
						...
						<option value="Balalaikas">Balalaikas</option>
						<option value="Lyre">Lyre</option>
						<option value="Harps">Harps</option>
						<option value="Lutes">Lutes</option>
						<option value="Violas">Violas</option>
						<option value="Samisen">Samisen</option>
					</select>
				</form>
			</div>
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													...
													<li>
														<a href="product.html">Ukuleles</a>
													</li>
													<li>
														<a href="product.html">Violins</a>
													</li>
													<li>
														<a href="product.html">Contrabasses</a>
													</li>
													<li>
...
<!--    <script src="js/jquery-3.3.1.min.js"></script>-->
    ...
    <script src="js/myScript/index.js"></script>
